...
// %bb.0:
	...
	sw r22, -16, r1
.Ltmp0:
	//DEBUG_VALUE: if_in_front:buffers <- [DW_OP_constu 16, DW_OP_minus] [$r22+0]
	move r15, r0
	//DEBUG_VALUE: run <- 64
.Ltmp1:
...
.LBB0_9:                                //   in Loop: Header=BB0_1 Depth=1
	//DEBUG_VALUE: if_in_front:buffers <- [DW_OP_constu 16, DW_OP_minus] [$r22+0]
	//DEBUG_VALUE: if_in_front:sr <- $r15
	//DEBUG_VALUE: run <- [DW_OP_constu 28, DW_OP_minus] [$r22+0]
	.loc	2 14 5 prologue_end             // dpu/task.c:14:5
	lsr r0, r18, 20
	lw r18, r22, -28
.Ltmp3:
	//DEBUG_VALUE: run <- $r18
...
.LBB0_8:                                //   in Loop: Header=BB0_2 Depth=2
	//DEBUG_VALUE: if_in_front:buffers <- [DW_OP_constu 16, DW_OP_minus] [$r22+0]
	//DEBUG_VALUE: if_in_front:sr <- $r15
	//DEBUG_VALUE: j <- [DW_OP_constu 32, DW_OP_minus] [$r22+0]
	lw r19, r22, -32
.Ltmp8:
	//DEBUG_VALUE: j <- $r19
	.loc	2 15 9 is_stmt 1                // dpu/task.c:15:9
	lsr r0, r19, 21
	lw r18, r22, -24
	jneq r0, 0, .LBB0_9
.Ltmp9:
.LBB0_2:                                //   Parent Loop BB0_1 Depth=1
	...
	lw r16, r22, -16
.Ltmp10:
	.loc	2 17 30 is_stmt 1               // dpu/task.c:17:30
	lw r0, r16, 0
	.loc	2 17 43 is_stmt 0               // dpu/task.c:17:43
	move r14, input
	lsl_add r1, r14, r19, 2
	.loc	2 17 17                         // dpu/task.c:17:17
	move r2, r15
	call r23, seqread256_init
.Ltmp11:
	move r17, r0
	.loc	2 16 25 is_stmt 1               // dpu/task.c:16:25
	sw r22, -48, r17
	.loc	2 18 30                         // dpu/task.c:18:30
	lw r0, r16, 4
	.loc	2 18 51 is_stmt 0               // dpu/task.c:18:51
	add r1, r19, r18
	.loc	2 18 43                         // dpu/task.c:18:43
	lsl_add r18, r14, r1, 2
	.loc	2 18 17                         // dpu/task.c:18:17
	move r1, r18
	lw r2, r22, -12
	call r23, seqread256_init
.Ltmp12:
	.loc	2 16 25 is_stmt 1               // dpu/task.c:16:25
	sw r22, -44, r0
	.loc	2 20 43                         // dpu/task.c:20:43
	sw r22, -40, r18
	.loc	2 22 26                         // dpu/task.c:22:26
	lw r0, r22, -28
	add r19, r19, r0
.Ltmp13:
	sw r22, -32, r19
	.loc	2 22 18 is_stmt 0               // dpu/task.c:22:18
	lsl_add r0, r14, r19, 2
	.loc	2 20 43 is_stmt 1               // dpu/task.c:20:43
	sw r22, -36, r0
.Ltmp14:
	//DEBUG_VALUE: i <- 0
...
.LBB0_7:                                //   in Loop: Header=BB0_3 Depth=3
	...
	//DEBUG_VALUE: if_in_front:sr <- $r15
	//DEBUG_VALUE: i <- $r19
	.loc	2 35 21 is_stmt 1               // dpu/task.c:35:21
	move r0, r17
	move r1, r18
...
.LBB0_3:                                //   Parent Loop BB0_1 Depth=1
	...
	//DEBUG_VALUE: i <- $r19
	.loc	2 27 26 is_stmt 1               // dpu/task.c:27:26
	xor r20, r1, 1
	and r2, r20, 1
	add r0, r22, -48
	.loc	2 27 22 is_stmt 0               // dpu/task.c:27:22
	lsl_add r2, r0, r2, 2
	lw r2, r2, 0
	.loc	2 27 21                         // dpu/task.c:27:21
	lw r2, r2, 0
	.loc	2 27 37                         // dpu/task.c:27:37
	lw r3, r17, 0
	jltu r2, r3, .LBB0_5
.Ltmp18:
...
.LBB0_5:                                //   in Loop: Header=BB0_3 Depth=3
	...
	//DEBUG_VALUE: if_in_front:sr <- $r15
	//DEBUG_VALUE: active <- undef
	.loc	2 30 31 is_stmt 1               // dpu/task.c:30:31
	and r14, r20, 1
	lsl_add r21, r0, r14, 2
	lw r0, r21, 0
	.loc	2 30 30 is_stmt 0               // dpu/task.c:30:30
	lw r1, r0, 0
	.loc	2 30 24                         // dpu/task.c:30:24
	add r16, r19, 1
.Ltmp20:
	//DEBUG_VALUE: i <- $r16
	.loc	2 30 17                         // dpu/task.c:30:17
	lsl r2, r19, 2
	.loc	2 30 28                         // dpu/task.c:30:28
	sw r2, cache, r1
	.loc	2 31 68 is_stmt 1               // dpu/task.c:31:68
	lsl_add r18, r15, r14, 3
	move r1, 4
	.loc	2 31 31 is_stmt 0               // dpu/task.c:31:31
	move r2, r18
	call r23, seqread256_get
.Ltmp21:
	move r17, r0
	.loc	2 31 29                         // dpu/task.c:31:29
	sw r21, 0, r17
	move r19, 0
	jeq r16, 64, .LBB0_7
.Ltmp22:
// %bb.6:                               //   in Loop: Header=BB0_3 Depth=3
	...
	//DEBUG_VALUE: i <- $r16
	//DEBUG_VALUE: if_in_front:sr <- $r15
	.loc	2 32 21 is_stmt 1               // dpu/task.c:32:21
	move r19, r16, true, .LBB0_7
.Ltmp23:
.LBB0_10:
	//DEBUG_VALUE: if_in_front:buffers <- [DW_OP_constu 16, DW_OP_minus] [$r22+0]
	//DEBUG_VALUE: if_in_front:sr <- $r15
	.loc	2 41 1                          // dpu/task.c:41:1
	ld d20, r22, -80
	ld d18, r22, -72
	ld d16, r22, -64
	ld d14, r22, -56
...
// %bb.0:
	...
	move r0, 1
.Ltmp27:
	.loc	2 77 5 prologue_end             // dpu/task.c:77:5
	move r1, r0
	call r23, perfcounter_config
.Ltmp28:
	.loc	2 80 39                         // dpu/task.c:80:39
	call r23, seqread256_alloc
.Ltmp29:
	.loc	2 80 37 is_stmt 0               // dpu/task.c:80:37
	sw r22, -40, r0
	.loc	2 80 56                         // dpu/task.c:80:56
	call r23, seqread256_alloc
.Ltmp30:
	.loc	2 80 37                         // dpu/task.c:80:37
	sw r22, -36, r0
	.loc	2 83 14 is_stmt 1               // dpu/task.c:83:14
...
.Ltmp32:
	...
	add r0, r22, -32
	add r1, r22, -40
	.loc	2 84 5 is_stmt 1                // dpu/task.c:84:5
	call r23, if_in_front
.Ltmp33:
	.loc	2 85 14                         // dpu/task.c:85:14
	call r23, perfcounter_get
.Ltmp34:
	.loc	2 85 32 is_stmt 0               // dpu/task.c:85:32
	sub r1, r1, r15
	subc r0, r0, r14
.Ltmp35:
	//DEBUG_VALUE: main:cycles <- $d0
	.loc	2 86 43 is_stmt 1               // dpu/task.c:86:43
	call r23, __floatundidf
.Ltmp36:
	.loc	2 86 60 is_stmt 0               // dpu/task.c:86:60
	lw r2, zero, CLOCKS_PER_SEC
	.loc	2 86 43                         // dpu/task.c:86:43
	movd d14, d0
	.loc	2 86 60                         // dpu/task.c:86:60
	move r0, r2
.Ltmp37:
	call r23, __floatunsidf
.Ltmp38:
	movd d2, d0
	.loc	2 86 58                         // dpu/task.c:86:58
	movd d0, d14
	call r23, __divdf3
.Ltmp39:
	...
	move r3, 0
	move r2, 1083129856
	.loc	2 86 75                         // dpu/task.c:86:75
	call r23, __muldf3
.Ltmp40:
	.loc	2 86 5                          // dpu/task.c:86:5
	move r2, .L.str
	sd r22, -16, d0
	move r0, r2
	call r23, printf
.Ltmp41:
	...
	move r0, 0
	.loc	2 92 1 is_stmt 1                // dpu/task.c:92:1
	ld d14, r22, -48
	ld d22, r22, -8
	jump r23
.Ltmp42:
...
.Ldebug_info_start0:
	...
	.long	.Ltmp23-.Ltmp5                  // DW_AT_high_pc
	...
	.long	.Ltmp23-.Ltmp10                 // DW_AT_high_pc
...
.Linfo_string16:
	.asciz	"main"                          // string offset=315
.Linfo_string17:
	.asciz	"int"                           // string offset=320
.Linfo_string18:
	.asciz	"ptr"                           // string offset=324
.Linfo_string19:
	.asciz	"ends"                          // string offset=328
.Linfo_string20:
	.asciz	"sr"                            // string offset=333
.Linfo_string21:
	.asciz	"wram_cache"                    // string offset=336
.Linfo_string22:
	.asciz	"uintptr_t"                     // string offset=347
.Linfo_string23:
	.asciz	"seqreader_buffer_t"            // string offset=357
.Linfo_string24:
	.asciz	"mram_addr"                     // string offset=376
.Linfo_string25:
	.asciz	"seqreader_t"                   // string offset=386
.Linfo_string26:
	.asciz	"buffers"                       // string offset=398
.Linfo_string27:
	.asciz	"run"                           // string offset=406
.Linfo_string28:
	.asciz	"size_t"                        // string offset=410
.Linfo_string29:
	.asciz	"j"                             // string offset=417
.Linfo_string30:
	.asciz	"i"                             // string offset=419
.Linfo_string31:
	.asciz	"active"                        // string offset=421
.Linfo_string32:
	.asciz	"_Bool"                         // string offset=428
.Linfo_string33:
	.asciz	"cycles"                        // string offset=434
.Linfo_string34:
	.asciz	"long unsigned int"             // string offset=441
.Linfo_string35:
	.asciz	"uint64_t"                      // string offset=459
.Linfo_string36:
	.asciz	"perfcounter_t"                 // string offset=468
	.addrsig
	.addrsig_sym input
